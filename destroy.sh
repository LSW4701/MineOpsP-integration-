...
while true; do
    ...
    case $yn in
        [Yy]* ) cd cd $DIR/env/ec2/ec2-instance; terraform destroy -auto-approve ; cd $DIR/env/terraform-eks/3-irsa ; terraform destroy -auto-approve ;cd $DIR/env/terraform-aws-ubuntu/network ; terraform destroy -auto-approve ; break;;
        [Nn]* ) exit;;
